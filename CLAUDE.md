...
The `optiona-readings.md` file contains the full list of papers htstructured summaries of academic papers for a social cognition course. Each paper follows a standardized format to ensure consistency and readability.
